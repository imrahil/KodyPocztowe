cls
call "c:\Dev\Flex_SDK\blackberry-tablet-sdk-2.0.0\bin\amxmlc.bat" +configname=airmobile -library-path+=libs -output bin-release\KodyPocztowe.swf src\KodyPocztowe.mxml
